...
--
--
--  $Id: sgl-maps.ads,v 2.1 1997/07/12 00:39:33 akonstan Exp $
--
...
package SGL.Maps is
   ...
   package Rep_Type is new SGL.Trees
     (Key_T, "<", Pair_Type, Map_Pairs_Extension.Assign, Select1st,
      Initialize, Finalize, Map_Pairs_Controlled.Initialize,
      Map_Pairs_Controlled.Adjust, Map_Pairs_Controlled.Finalize);
