...
--
--
--  $Id: sgl-front_insertion_sequence_containers.ads,v 2.1 1997/07/12 00:39:33 akonstan Exp $
--
...
generic
   ...
   -- Front Insertion Sequence Container Operations

   with procedure Push_Front(C: in out Container;
                             E: in Forward_Iterators.Value_Type) is <>;
   with procedure Pop_Front(C: in out Container) is <>;


package SGL.Front_Insertion_Sequence_Containers is
...
end SGL.Front_Insertion_Sequence_Containers;
