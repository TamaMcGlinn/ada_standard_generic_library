...
--
--
--  $Id: sgl-random_access_constant_iterators.ads,v 2.1 1997/07/12 00:39:33 akonstan Exp $
--
...
generic
   ...
   with function "+" (K: Distance_Type_Operations.T; I: in Constant_Iterator)
                      return Constant_Iterator is <>;
...
package SGL.Random_Access_Constant_Iterators is
   subtype Distance_Type is Distance_Type_Operations.T;

end SGL.Random_Access_Constant_Iterators;
