...
--
--
--  $Id: sgl-reversible_containers.ads,v 2.1 1997/07/12 00:39:33 akonstan Exp $
--
...
generic
   ...
   with package Reverse_Iterators is new SGL.Bidirectional_Iterators(<>);
   ...
   with function Start(C: in Container_Pointer)
                       return Bidirectional_Iterators.Iterator is <>;
   with function Start(C: in Container)
                       return Bidirectional_Iterators.Constant_Iterator is <>;
...
package SGL.Reversible_Containers is
   ...
   subtype Constant_Iterator is Bidirectional_Iterators.Iterator;
